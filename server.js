...
// Получение поштоматов Новой Почты
app.post('/api/postmats', async (req, res) => {
  try {
    ...
    if (result.success) {
      // Фильтруем только поштоматы (TypeOfWarehouse === '9a68df70-0267-42a8-bb5c-37f427e36ee4')
...
app.post('/api/order', async (req, res) => {
  try {
    ...
    // и интеграцию с API Новой Почты для создания накладной
